...
import { getPlayerPosition } from '../components/WorldStage';
import { peers, addClient, removeClient } from './peers';

//Datastore of whatever

const store = proxy({ camera: {} });
...
if (typeof window !== 'undefined') {
  ...
  window.onload = async () => {
    console.log('Window loaded in Network.js.');
...
function initSocketConnection() {
  ...
  mySocket.on('introduction', otherClientIds => {
    console.log('Introduction triggered', 'My SocketID', mySocket.id);
  ...
  mySocket.on('newUserConnected', theirId => {
    console.log('New User Connected, MyId', mySocket.id, 'theirId', theirId);
